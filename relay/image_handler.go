...
func ImageHelper(c *gin.Context) (newAPIError *types.NewAPIError) {
	...
	if resp != nil {
		...
		if httpResp.StatusCode != http.StatusOK {
			...
			postConsumeQuota(c, relayInfo, nil, 0, userQuota, priceData, newAPIError.Error.Message, sourceModel, bodyContent)
			return newAPIError
		}
	}
	...
	postConsumeQuota(c, relayInfo, usage.(*dto.Usage), preConsumedQuota, userQuota, priceData, logContent, sourceModel, bodyContent)
	return nil
}
