...
type GreedImage struct {
	...
	Nsfw        int    `json:"nsfw" gorm:"type:tinyint;default:0;index;comment:Is Not Safe For Work? 0-涩图 1-R18 2-妹子图 3-jk 4-bs 5-hs 6-luoli"`
...
func GetGreedRandomImageUrlByNum(num int, nsfw int, keyword string) (greedImage *GreedImage, err error) {
	tx := DB
	if nsfw >= 0 {
...
func AddGreedRandomImage(url string, nsfw int, contentType string, keyword string) (err error) {
